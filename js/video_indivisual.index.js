...
function save_coment_API()
{
    ...
    if ($('#valtext').val() != '')
    {
        ...
        $.ajax({
            url: $('#base_url').val() + "sadmin/save_coments_API",
            type: "GET",
...
function save_coment_API_student()
{
    ...
    if ($('#valtext').val() != '')
    {
        ...
        $.ajax({
            url: $('#base_url').val() + "instructor/save_coments_API_std",
            type: "GET",
            context: document.body,
            data: "title=" + $('#videotitle').val() + "&id=" + $('#videoid').val() + "&url=" + $('#videoname').val() + "&rank=" + $('#testrate').val() + "&coment=" + $('#valtext').val() + "&maintitle=" + $('#maintitle').val(),
            cache: false,
            success: function(data) {
                $('#addcment').html('<span class="success">Comment Added Successfully</span>').show().delay(1800).slideUp(2000);
                $('#hide_commnts').hide();
                $('#cm_tbl').append(data);
...
function save_coment()
{
    ...
    $.ajax({
        url: $('#base_url').val() + "sadmin/save_coments",
        type: "GET",
        context: document.body,
        data: "coment=" + $('#valtext').val() + "&id=" + $('#videoid').val() + "&url=" + $('#videoname').val() + "&rank=" + $('#testrate').val(),
        cache: false,
        success: function(data) {
