   ...
   function checkFrame() {
	...
	function new_field_add()
	{
		...
		{
			$('#event_typer_add').append('<tr id='+id+'><td><input type="text" value="" /></td><td><input type="checkbox" /><br/><span onClick="removeitem('+id+')" style="cursor:pointer; color:#900"><b>remove</b></span></td></tr>');	
	...
	function show_event(id,event_done)
	{
						...
						$.ajax({
							...
							var obj = JSON.parse(data);
									...
									if(obj[0]['invite_status']==='undefined')
									{
									...
									if(view_checker)
									{
										...
										if(obj[0]['ev_event_type']=='Assignment' || obj[0]['ev_event_type']=='Reading')
										{
											$('.canremove').hide();											
										}else
										{
