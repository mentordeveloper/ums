...
function selector_event(title, is_flag) {
    ...
    var title = title;
    if (title == '') {
        title = $('#select_id_cal :selected').val();
    } else
        title = title;
    ...
    if ($('#select_id_cal :selected').text() == 'Assignment' || $('#select_id_cal :selected').text() == 'Reading') {
        $('.canremove').hide();
    }
    else {
        ...
        alert($('#select_id_cal :selected').val());
        $.ajax({
            url: $('#base_url').val()
...
function Qtipshow(obj, id) {
    ...
    obj.qtip({
        content: {
            ...
            ajax: {
                url: $('#base_url').val()
                        + "instructor/get_event_by_id/?id=" + id + "&event_date=" + $('#hidden_date').val(),
                async: false,
            },
            title: {
