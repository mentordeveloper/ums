	...
	function push_call_confirm(course)
	{
							 ...
							 $.ajax({
									...
									success: function(data){
											...
											if(data<=1)
											{
												$('#notification_sended').html('Notfication sent to '+data+' student');$('#notification_sended').slideDown('slow', function() { $('#notification_sended').delay(1800).slideUp(2000); });
												
											}else
											{
												$('#notification_sended').html('Notfication sent to '+data+' students');$('#notification_sended').slideDown('slow', function() { $('#notification_sended').delay(1800).slideUp(2000); });
...
//	}
	...
	$(function() {
			...
			$('#origional').append('<tr><td valign="top" width="60"><select name="date[]"><option value="sunday">Sunday</option><option value="monday">Monday</option><option value="tuesday">Tuesday</option><option value="wednesday">Wednesday</option><option value="thursday">Thursday</option><option value="friday">Friday</option><option value="saturday">Saturday</option></select></td><td valign="top" width="60"><input name="start_time[]" style="width:100px;" id="'+id2+'" type="text" /></td><td valign="top" width="60"><input name="end_time[]" style="width:100px;" id="'+id3+'"  type="text"  /></td><td valign="top" width="150"><br/></td><input name="action[]" style="width:100px;" type="hidden" value="new"  /><input name="ids[]" style="width:100px;" type="hidden" value="none"  /></tr>');
